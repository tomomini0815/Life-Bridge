                ...
                <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
                    <section>
                        <p className="text-muted-foreground leading-relaxed">
                            LifeBridge(以下「当社」といいます)は、本ウェブサイト上で提供するサービス(以下「本サービス」といいます)における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー(以下「本ポリシー」といいます)を定めます。
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground mb-4">当社が個人情報を収集・利用する目的は、以下のとおりです。</p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4">第10条(お問い合わせ窓口)</h2>
                        <p className="text-muted-foreground leading-relaxed">
