...
import { Bell, BellOff, Clock, Check, X, AlertCircle } from 'lucide-react';
        ...
        <div className="space-y-6 animate-fade-in max-w-4xl mx-auto pb-10">
            ...
            <div className="glass-medium rounded-3xl p-8 border border-border/50 shadow-soft">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-foreground font-display">リマインダー設定</h1>
                        <p className="text-muted-foreground">期限を逃さないための通知設定</p>
                    </div>
                </div>
            </div>
