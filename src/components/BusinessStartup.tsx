...
export function BusinessStartup({ event, completedTaskIds, userUrgentTaskIds, isPriorityEvent, onToggleTask, onToggleUrgentTask, onTogglePriorityEvent }: BusinessStartupProps) {
